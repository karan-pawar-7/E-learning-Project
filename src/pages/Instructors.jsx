    ...
    <>
      <div className='h-screen'>
        <div className=' text-center pt-20 text-2xl'>
          <button className='text-purple-800 text-[15px] font-bold rounded-2xl bg-gray-100 px-3 py-1'>World-Class Instructors</button>
        ...
        <div className='flex gap-8 p-8'>
          <div className='shadow-2xl rounded-4xl'>
            <img className='rounded-t-4xl h-70 w-260 ' src="./public/i1.jpg" alt="" />
            <p className='text-[20px] px-7 pt-7'>Sarah Johnson</p>
          ...
          <div className='shadow-2xl rounded-4xl'>
            <img className='rounded-t-4xl h-70 w-260  ' src="./public/i2.jpg" alt="" />
            <p className='text-[20px] px-7 pt-7'>Michael Chen</p>
          ...
          <div className='shadow-2xl rounded-4xl'>
            <img className='rounded-t-4xl h-70 w-260  ' src="./public/i3.jpg" alt="" />
            <p className='text-[20px] px-7 pt-7'>Emma Rodriguez</p>
          ...
          <div className='shadow-2xl rounded-4xl w-85'>
            <img className='rounded-t-4xl h-70 w-90' src="./public/i4.jpg" alt="" />
            <p className='text-[20px] px-7 pt-7'>David Kumar</p>
