    ...
    <>
      ...
      >
        <div className="text-center pt-20 text-2xl">
          ...
          >
            Our expert instructors bring real-world experience and passion to
            every course
          </p>
        </div>

        <div className="flex gap-8 p-8 flex-wrap justify-center">
          {/* Card 1 */}
          <div
          ...
          >
            <img
              className="rounded-t-4xl h-70 w-90"
              src="./public/t1.png"
              alt=""
            />
            ...
            <div className="flex gap-4 px-7 pt-2">
              <button className="text-purple-800 text-[15px] font-bold rounded-2xl bg-gray-100 px-3 py-1">
                React
              </button>
              <button className="text-purple-800 text-[15px] font-bold rounded-2xl bg-gray-100 px-3 py-1">
                Node.js
            ...
            <div
              className={`flex justify-between px-7 pt-3 pb-5 border-t mt-3 ${
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <FontAwesomeIcon className="text-gray-400" icon={faBook} />
                <div>
                  <h1>12</h1>
                  <h1
                    className={
...
{/* Card 3 */}
          ...
          >
            ...
            <p className="text-[20px] px-7 pt-7">Kishori Varma</p>
...
{/* Card 3 */}
          ...
          {/* Card 4 */}
          <div
            className={`shadow-2xl rounded-4xl w-85 ${
              darkMode ? "bg-gray-900" : "bg-white"
            }`}
          >
            <img
