  ...
  return (
    <div
      className={`min-h-screen transition-all duration-500 ${
        darkMode ? "bg-gray-950 text-white" : "bg-[#fafbff] text-black"
      }`}
    >
      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-6 lg:px-10 pt-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p
              className={`text-lg leading-9 mt-8 max-w-xl ${
          ...
          <div className="relative flex justify-center">
            <div
              className={`absolute w-[550px] h-[550px] rounded-full blur-3xl opacity-70 ${
                darkMode
                  ? "bg-gradient-to-br from-purple-900 via-pink-900 to-orange-900"
                  : "bg-gradient-to-br from-purple-200 via-pink-100 to-orange-100"
              }`}
            ></div>
      ...
      {/* Stats */}
      <section className="max-w-7xl mx-auto px-6 mt-20 pb-14">
        <div
          className={`rounded-3xl shadow-xl p-10 grid grid-cols-2 lg:grid-cols-4 gap-8 transition-all duration-500 ${
        ...
        >
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <h2 className="text-4xl font-bold text-pink-600">100K+</h2>
              <p className={darkMode ? "text-gray-300" : "text-gray-500"}>
                Active Students
              </p>
            </div>
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <h2 className="text-4xl font-bold text-orange-500">4.9/5</h2>
              <p className={darkMode ? "text-gray-300" : "text-gray-500"}>
                Average Rating
              </p>
            </div>
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <h2 className="text-4xl font-bold text-violet-600">50+</h2>
              <p className={darkMode ? "text-gray-300" : "text-gray-500"}>
                Awards Won
              </p>
            </div>
