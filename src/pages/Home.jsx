        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          ...
          <div className="flex flex-col items-center justify-center gap-8">
           ...
           <h1 className="text-7xl font-bold bg-gradient-to-r from-violet-700 via-pink-500 to-orange-400 bg-clip-text text-transparent">Learn Skills
            ...
            <p className='text-[20px] text-white'>Master in-demand skills with world-class instructors. Build your <br /> future with curated courses designed for modern professionals.</p>
            ...
            <div className='flex gap-7 text-center'>
              <div className='border-r border-zinc-400 p-3'>
                ...
                <p className='text-white'>Expert Courses</p>
              </div>
              <div className='border-r border-zinc-400 p-3'>
                <h1 className='text-4xl font-bold text-white'>100K+</h1>
                <p className='text-white'>Active Students</p>
              </div>
              <div className='border-r  border-zinc-400 p-3'>
                <h1 className='text-4xl font-bold text-white'>4.9/5</h1>
